...
* k = 10. The step is always Constant in this exercise
"""
...
num_tests = 2 # Should be equal to the number of epsilon values provided
epsilon = [0, 0.1] # Takes values between 0 and 1
step = "Constant"
    ...
    def run_test(self):
        ...
        for sim in range(self.num_simulations):
            ...
            for time in range(self.time_steps):
                ...
                # If environment is non stationary, change the true values of each action
                if env != 's':
...
env = "s" # Stationary or non stationary -> takes value s or n
...
env = "n" # Stationary or non stationary -> takes value s or n
