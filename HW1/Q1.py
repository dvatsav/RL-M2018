        ...
        for sim in range(self.num_simulations):
            ...
            for time in range(self.time_steps):
                ...
                if rand() > self.epsilon:
                    arm = avg_reward.index(max(avg_reward))
                else:
                ...
                avg_reward[arm] = avg_reward[arm] + \
                    alpha * (reward - avg_reward[arm])
...
if __name__ == '__main__':
    ...
    * Parse Arguments
    ...
    parser.add_argument('-s', '--num_simulations', action='store',
                        help="Number of Simulations to Run", type=check_positive, default=200)
    parser.add_argument('-t', '--time_steps', action='store',
                        help="Number of Time Steps per simulation", type=check_positive, default=10000)
    ...
    parser.add_argument('-n', '--num_tests', action='store',
                        help='Number of tests to run', default=1, type=check_positive)
    parser.add_argument('-e', '--epsilon', nargs='+', default=[0.1],
